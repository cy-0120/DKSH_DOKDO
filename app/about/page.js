    ...
    <div className="gallery__grid">
      {items.map((item) => {
        ...
        const sci =
          typeof item === "string"
            ? formatName(item)
            : item.sci || (ko ? null : formatName(item.file));
        return (
...
const LAND_PLANTS = [
  ...
  {
    file: "lysimachia-mauritiana.jpg",
    ko: "갯까치수염",
    sci: "Lysimachia mauritiana",
  },
  {
    file: "phedimus-takesimensis.jpg",
    ko: "섬기린초",
    sci: "Phedimus takesimensis",
  },
];
...
const SEA_PLANTS = [
  ...
  {
    file: "sargassum-horneri.jpg",
    ko: "괭생이모자반",
    sci: "Sargassum horneri",
  },
  {
    file: "sargassum-thunbergii.jpg",
    ko: "지충이",
    sci: "Sargassum thunbergii",
  },
...
const SEA_ANIMALS = [
  ...
  {
    file: "protaeolidiella-atra.jpg",
    ko: "검정큰도롱이갯민숭이",
    sci: "Protaeolidiella atra",
  },
  {
  ...
  {
    file: "tritonia-festiva.jpg",
    ko: "예쁜이갯민숭이",
    sci: "Tritonia festiva",
  },
  {
    file: "chromodoris-orientalis-rudman.jpg",
    ko: "흰갯민숭달팽이",
    sci: "Chromodoris orientalis Rudman",
  },
];
...
const MANAGEMENT = [
  ...
  {
    key: "보호구역 지정",
    val: "자연환경보전지역 · 특정도서 · 천연보호구역 중복 지정",
  },
];
    ...
    <>
      ...
      <section className="section" id="about-intro">
        <div className="container">
          ...
          <p className="section__lead">
            위치와 지형, 행정 정보, 그리고 그 안에서 살아가는 식물과 동물까지
            <br />
            독도를 이루는 모든 것을 자세히 둘러봅니다.
          </p>
        </div>
      </section>
      ...
      <section className="section section--alt" id="location">
        <div className="container">
          ...
          <p className="section__lead">
            독도는 울릉도에서 동남쪽으로 약 87.4km 떨어져 있습니다. 일본
            오키섬(약 157.5km)보다
            <br />
            우리 울릉도에 훨씬 더 가깝습니다.
          </p>
          ...
          <p className="location__quote">
            “독도는 울릉도의 부속 섬으로, 역사·지리·국제법적으로 명백한
            대한민국의 영토입니다.”
          </p>
          ...
          <p className="section__lead">
            독도는 약 460만 년 전 해저 화산 활동으로 생겨난 화산섬으로, 동도와
            서도 및 89개의 부속 도서로 이루어져 있습니다. 최고봉은 서도의
            대한봉으로 높이 168.5m입니다.
          </p>
          ...
          <p className="section__lead">
            독도는 난류의 영향을 받는 해양성 기후로, 연중 흐린 날이 160일 이상일
            만큼 안개와 강수가 잦고 바람이 강합니다.
          </p>
      ...
      <section className="section" id="administration">
        <div className="container">
          ...
          <p className="section__lead">
            독도는 대한민국 경상북도 울릉군에 속한 행정구역이며, 독도경비대가
            상주하며 지키고 있습니다.
          </p>
          <div className="facts__table">
            {FACTS.map((f) => (
      ...
      <section className="section section--alt" id="nature">
        <div className="container">
          ...
          <p className="section__lead">
            거친 해풍 속에서도 다양한 식물과 동물이 독도 곳곳에서 살아가고
            있습니다. 육지에서 멀리 떨어진 화산섬이라는 특수한 환경 덕분에
            독자적인 생태계가 유지되어 왔으며, 이런 생태적 가치를
            <br />
            인정받아 1982년 &ldquo;독도 해조류 번식지&rdquo;라는 이름으로
            천연기념물 제336호에 지정되었고, 1999년 지금의 이름인 「독도
            천연보호구역」으로 변경되었습니다.
          </p>
          ...
          <p className="section__lead">
            독도는 동해안 지역에서 괭이갈매기, 바다제비, 슴새 등 바닷새가
            대규모로 번식하는 유일한 곳이자 철새들의 중간 기착지입니다. 다양한
            해양 생물도 독도 주변 바다에서 살아가며, 한때 이곳을
            <br />
            터전으로 삼았던 강치는 20세기 초 일본의 남획으로 지금은
            멸종되었습니다.
          </p>
          <div className="gallery__group">
