        ...
        <div className="container">
          ...
          <div className="about__grid">
            <div className="about__text">
              <p>
                <strong>독도(獨島)</strong>는 대한민국 경상북도 울릉군에 속한
                섬으로, 동해의 가장 동쪽에 자리합니다. 동도(東島)와 서도(西島),
                그리고 89개의 부속 도서로 이루어진 화산섬입니다.
              </p>
              <p>
                약 460만 년 전 해저 화산 활동으로 생겨난 독도는 우리나라에서
                가장 오래된 화산섬 중 하나입니다. 거친 파도와 바람 속에서도
                다양한 생명이 살아가는 생태계의 보고이자, 자연이 빚어낸 예술
                작품입니다.
              </p>
              <p>
                맑은 날에는 울릉도에서 육안으로 독도를 볼 수 있을 만큼 가까우며,
                예로부터 우리 조상들의 삶과 역사가 깃든 소중한 우리 땅입니다.
              </p>
            </div>
      ...
      <section className="section section--alt" id="location">
        <div className="container">
          ...
          <p className="section__lead">
            ...
            오키섬(약 157km)보다 우리 울릉도에 훨씬 더 가깝습니다.
          </p>
      ...
      <section className="closing">
        <div className="container">
          ...
          <p className="closing__text">
            일본의 주장에 대한 근거 자료, 자주 묻는 질문, 독도 방문 안내까지
            확인해 보세요.
          </p>
