...
export const PERIODS = [
  { key: "dawn", start: 4, end: 7, file: "/img/dokdo-time/dokdo-dawn.webp" },
  {
    ...
    file: "/img/dokdo-time/dokdo-morning.webp",
  },
  {
    key: "afternoon",
    start: 11,
    end: 17,
    file: "/img/dokdo-time/dokdo-afternoon.webp",
  },
  {
    key: "evening",
    start: 17,
    end: 20,
    file: "/img/dokdo-time/dokdo-evening.webp",
  },
  {
    key: "night",
    start: 20,
    end: 28,
    file: "/img/dokdo-time/dokdo-night.webp",
  },
];
...
export function getPeriod(hour) {
  ...
  return (
    PERIODS.find((p) => h >= p.start && h < p.end) ||
